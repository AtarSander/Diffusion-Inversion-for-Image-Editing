...
def _download_audio(x):
    ...
    ydl_opts = {
        ...
        # Add additional robustness options
    ...
    for attempt in range(max_attempts):
        try:
            ...
            if attempt == max_attempts - 1:  # Last attempt
                print(f"Failed to download {ytid} after {max_attempts} attempts: {str(e)}")
            else:
                print(f"Download attempt {attempt + 1} failed for {ytid}, retrying...")

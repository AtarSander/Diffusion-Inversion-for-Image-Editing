...
# ABOUTME: the environment setup job. Guards against empty vars silently choosing a CPU node.
#
# Usage (from audio/):  bash editing/AudioEditingCode/code/slurm_scripts/wcss/submit_setup.sh
...
sbatch \
  ...
  "$@" \
  editing/AudioEditingCode/code/slurm_scripts/wcss/run_setup_env.sh

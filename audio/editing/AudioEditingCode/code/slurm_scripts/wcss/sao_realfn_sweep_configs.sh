# ABOUTME: Edit sweep for the real-audio forward-noise adapter: the saocos_realfn checkpoint
# ABOUTME: over the standard odeinv grid, paired against the no-LoRA twins and the trajectory-
# ABOUTME: trained adapters already scored at identical settings.

LORA_MODE=odeinv
# Written by run_train_inversion_lora.sh preset 37 (RUN_PREFIX=saocos_). No no-LoRA entry: the
...
# stableaudio_odeinvlora_hparam_saocos_realfn_r8_a4_lr5e-5_checkpoint_step_3000_cfgtar<c>_t<t>_s100,

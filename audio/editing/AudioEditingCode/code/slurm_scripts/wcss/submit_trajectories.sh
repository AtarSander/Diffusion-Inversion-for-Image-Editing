...
# ABOUTME: the trajectory generation array. Guards against empty vars silently choosing a CPU node.
#
# Usage (from audio/):  bash editing/AudioEditingCode/code/slurm_scripts/wcss/submit_trajectories.sh
...
sbatch \
  ...
  "$@" \
  editing/AudioEditingCode/code/slurm_scripts/wcss/run_generate_trajectories.sh

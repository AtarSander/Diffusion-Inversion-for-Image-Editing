...
# ABOUTME: the trajectory verification job. Guards against empty vars silently choosing a CPU node.
#
# Usage (from audio/):  bash editing/AudioEditingCode/code/slurm_scripts/wcss/submit_verify.sh
...
sbatch \
  ...
  "$@" \
  editing/AudioEditingCode/code/slurm_scripts/wcss/run_verify_trajectories.sh

...
def build_train_sampler(
    ...
    """Use the existing final-tail sampler without coupling it to CFG target mode."""
...
def main(cfg: DictConfig) -> None:
    # W&B reads WANDB_API_KEY from the repository environment file.

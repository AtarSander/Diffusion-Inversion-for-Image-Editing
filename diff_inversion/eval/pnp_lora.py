"""Run PnP editing evaluation with LoRA-assisted SD1.5 inversion."""
...
@hydra.main(config_path="../../config", config_name="eval/pnp_lora", version_base=None)
def main(cfg: DictConfig) -> None:
    logger.info("PnP LoRA eval config:\n{}", OmegaConf.to_yaml(cfg))
    ...
    if not (data_path / "mapping_file.json").exists():
        raise FileNotFoundError(f"PnP mapping file does not exist: {data_path / 'mapping_file.json'}")

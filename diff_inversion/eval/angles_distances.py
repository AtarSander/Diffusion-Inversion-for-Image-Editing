...
def calc_angles(noises, samples, latents):
    ...
    mean_cossim_noise, std_cossim_noise = get_cossim_mean_std(
        vec_noise_to_image, vec_noise_to_latent
    )
    mean_cossim_latent, std_cossim_latent = get_cossim_mean_std(
        vec_latent_to_noise, vec_latent_to_image
    )
